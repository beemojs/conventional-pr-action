...
const errors = {
  ...
  COMMAND_MIXED_DEFAULT: 'A default command has been registered. Cannot mix default and non-default commands.',
  COMMAND_MIXED_NONDEFAULT: 'Other commands have been registered. Cannot mix default and non-default commands.',
  ...
  REACT_RENDER_NO_NESTED: 'A React render process already exists. Unable to render current command. This usually occurs by triggering nested program calls.',
  THEME_UNKNOWN: 'Theme could not be loaded. Attempted `@boost/theme-{0}` and `boost-theme-{0}`.'
};
const CLIError = internal.createScopedError('CLI', 'CLIError', errors);
