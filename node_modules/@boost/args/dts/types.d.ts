...
export declare type ArgList = string[];
export declare type ListType = number[] | string[];
...
export declare type OptionMap = Record<string, ValueType>;
export declare type UnknownOptionMap = Record<string, string>;
export declare type AliasMap = Record<string, string>;
...
export declare type MapOptionConfig<T extends object> = {
    [K in keyof T]: InferOptionConfig<T[K]>;
};
export declare type CommandChecker = (arg: string) => boolean;
export declare type ContextFactory = (arg: string, argv: Argv) => ParserOptions<{}> | undefined;
...
export declare type OptionConfigMap = Record<string, OptionConfig>;
/** Abstract type for easier typing. */
export declare type ParamConfig = Param<any>;
export declare type ParamConfigList = ParamConfig[];
