...
const errors = {
  ...
  GROUP_REQUIRED_COUNT: 'Numeric options must have `count` enabled when passed in a short option group.',
  GROUP_UNSUPPORTED_TYPE: 'Only boolean and countable number options may be used in a short option group.',
  ...
  PARAM_INVALID_ORDER: 'Optional param(s) {0} found before required param "{1}". Required must be first.',
  ...
  VALUE_NON_ARRAY: 'Option "{0}" is enabled for multiple values, but non-array default value found.',
...
const ArgsError = internal.createScopedError('ARG', 'ArgsError', errors);
exports.ArgsError = ArgsError;
//# sourceMappingURL=ArgsError.js.map
