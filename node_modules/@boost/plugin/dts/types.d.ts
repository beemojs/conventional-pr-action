...
export declare type Source = FilePath | ModuleName;
export declare type SourceOptions = boolean | object;
export declare type SourceWithOptions = [Source, SourceOptions];
export declare type Callback<T = unknown> = (value: T) => Promise<void> | void;
...
export declare type Setting = Record<string, SourceOptions>;
export declare type Factory<T extends Pluggable, O extends object = object> = (options: Partial<O>) => Promise<T> | T;
