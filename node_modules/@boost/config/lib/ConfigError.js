...
const errors = {
  ...
  ROOT_NO_PACKAGE: 'Config folder `{0}` found without a relative `package.json`. Both must be located in the project root.',
  ROOT_ONLY_OVERRIDES: 'Overrides setting `{0}` must only be defined in a root config.'
};
const ConfigError = internal.createScopedError('CFG', 'ConfigError', errors);
