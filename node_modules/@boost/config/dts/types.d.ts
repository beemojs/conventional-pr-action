...
export declare type ExtType = 'cjs' | 'js' | 'json' | 'json5' | 'mjs' | 'ts' | 'yaml' | 'yml';
export declare type LoaderType = Exclude<ExtType, 'yml'>;
export declare type Loader<T> = (path: Path, pkg: PackageStructure) => Promise<Partial<T>>;
export declare type Handler<T> = (prev: T, next: T) => Promise<T | undefined> | T | undefined;
export declare type FileSource = 'branch' | 'extended' | 'overridden' | 'root';
...
export declare type FileGlob = string[] | string;
export declare type ExtendsSetting = string[] | string;
...
export declare type OverridesSetting<T> = OverridesSettingItem<T>[];
export declare type PluginOptions = boolean | object;
export declare type PluginEntry = string | [string, PluginOptions];
export declare type PluginsSettingMap = Record<string, PluginOptions>;
export declare type PluginsSettingList = PluginEntry[];
export declare type PluginsSetting = PluginsSettingList | PluginsSettingMap;
